  ...
  quizzes: {
    ...
    foundation: [
      ...
      { id:'F07', type:'fill', chapter:'第8章', difficulty:2,
        ...
        ans:'ql/2; ql²/8', explain:'简支梁均布荷载：支座反力R_A=R_B=ql/2，跨中弯矩M_max=ql²/8。' },
      // 压杆
    ...
    specialized: [
      ...
      { id:'S02', type:'choice', chapter:'第1章', difficulty:3,
        ...
        opts:['静定结构','一次超静定结构','二次超静定结构','几何可变体系'], ans:0,
    ...
    advanced: [
      ...
      { id:'A02', type:'calc', chapter:'第9章', difficulty:3, stage:3,
        ...
        ans:'σ_max=126.6MPa<[σ]=160MPa✓; v_max=16.9mm',
      ...
      { id:'A04', type:'calc', chapter:'第13章', difficulty:4, stage:3,
        ...
        ans:'大柔度杆(λ=200>λ_p=101.7), F_cr=101.7kN',
    ...
    mock2: [
      ...
      { id:'X02', type:'choice', chapter:'综合', difficulty:3,
        ...
        opts:['纯弯曲','轴向压缩+弯曲','弯曲+扭转','纯压缩'], ans:1,
      ...
      { id:'X04', type:'calc', chapter:'综合', difficulty:4,
        ...
        ans:'σ_max=126.6MPa<160MPa✓; v_max=16.9mm≈l/473',
